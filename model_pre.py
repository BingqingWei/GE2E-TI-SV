...
import os
import time
from pre.utils import random_batch, normalize, similarity, loss_cal, optim
...
"""
Notes:
The role of w and b in scaling similarity?
In training, w and b are trainable parameters
but in test, w is set to 1 and b is set to 0 (as expected).
"""
